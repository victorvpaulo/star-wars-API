...
class PlanetToResponseTest {
    ...
    public void should_convert_many() {
        Planet planet1 = new Planet("5399aba6e4b0ae375bfdca88", "Tatooine", "Arid", "Desert");
        Planet planet2 = new Planet("607a72495196adef1e2d094b", "Alderaan", "Temperate", "Grasslands, Mountains");
        Planet planet3 = new Planet("539a7244d9d5e4dea11d4ffe", "Yavin IV", "Temperate", "Jungle, Rainforests");
        ...
        assertThat(responses).containsExactly(
            new PlanetResponse("5399aba6e4b0ae375bfdca88", "Tatooine", "Arid", "Desert"),
            new PlanetResponse("607a72495196adef1e2d094b", "Alderaan", "Temperate", "Grasslands, Mountains"),
            new PlanetResponse("539a7244d9d5e4dea11d4ffe", "Yavin IV", "Temperate", "Jungle, Rainforests")
        );
    }
}