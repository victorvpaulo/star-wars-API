...
class DocumentToPlanetTest {
    ...
    @Test
    void should_convert() {
        PlanetDocument planetDocument = new PlanetDocument("5399aba6e4b0ae375bfdca88", "Tatooine", "Arid", "Desert", null);
    ...
    public void should_convert_many() {
        PlanetDocument document1 = new PlanetDocument("5399aba6e4b0ae375bfdca88", "Tatooine", "Arid", "Desert", null);
        PlanetDocument document2 = new PlanetDocument("607a72495196adef1e2d094b", "Alderaan", "Temperate", "Grasslands, Mountains", null);
        PlanetDocument document3 = new PlanetDocument("539a7244d9d5e4dea11d4ffe", "Yavin IV", "Temperate", "Jungle, Rainforests", null);
        ...
        AssertionsForInterfaceTypes.assertThat(planets).containsExactly(
                new Planet("5399aba6e4b0ae375bfdca88", "Tatooine", "Arid", "Desert", null),
                new Planet("607a72495196adef1e2d094b", "Alderaan", "Temperate", "Grasslands, Mountains", null),
                new Planet("539a7244d9d5e4dea11d4ffe", "Yavin IV", "Temperate", "Jungle, Rainforests", null)
        );
    }
}